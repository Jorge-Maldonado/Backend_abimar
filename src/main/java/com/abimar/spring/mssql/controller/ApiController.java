...
public class ApiController {
    ...
    public ResponseEntity<Bitacora> updateBitacora(@RequestBody Bitacora bitacora) {
        Optional<Bitacora> bitacoraData =
                bitacoraRepository.findById(bitacora.getIdbitacora());
    ...
    public ResponseEntity<Direccion> updateDireccion(@RequestBody Direccion direccion) {
        Optional<Direccion> direccionData =
                direccionRepository.findById(direccion.getIddireccion());
    ...
    public ResponseEntity<TipoDocumento> createTipoDocumento(
    ...
    public ResponseEntity<TipoDocumento> readTipoDocumento(
            @RequestParam Long id) {

        Optional<TipoDocumento> tipoDocumentoData =
    ...
    public ResponseEntity<TipoDocumento> updateTipoDocumento(
        ...
        if (tipoDocumentoData.isPresent()) {
            ...
            _tipoDocumento.setIdtipodocumento(
                    tipoDocumento.getIdtipodocumento());
    ...
    public ResponseEntity<HttpStatus> deleteTipoDocumento(
            @RequestParam Long id) {
    ...
    public ResponseEntity<Permisos> updatePermisos(
            @RequestBody Permisos permisos) {

        Optional<Permisos> permisosData =
                permisosRepository.findById(permisos.getIdpermiso());
    ...
    public ResponseEntity<Modulo> updateModulo(@RequestBody Modulo modulo) {
        Optional<Modulo> moduloData =
                moduloRepository.findById(modulo.getIdmodulo());
    ...
    public ResponseEntity<Producto> createProducto(
        ...
        try {
            /*
             * Si el frontend no envía estos campos, se mantienen
             * en false por los valores iniciales de la entidad.
             */
            if (producto.getDestacado() == null) {
                producto.setDestacado(false);
            }

            if (producto.getMasVendido() == null) {
                producto.setMasVendido(false);
            }
    ...
    public ResponseEntity<Producto> readProducto(
            @RequestParam Long id) {

        Optional<Producto> productoData =
    ...
    public ResponseEntity<Producto> updateProducto(
        ...
        if (productoData.isPresent()) {
            ...
            _producto.setMasVendido(producto.getMasVendido());
    ...
    public ResponseEntity<Categoria> readCategoria(
            @RequestParam Long id) {

        Optional<Categoria> categoriaData =
    ...
    public ResponseEntity<Categoria> updateCategoria(
        ...
        Optional<Categoria> categoriaData =
                categoriaRepository.findById(categoria.getIdcategoria());
    ...
    public ResponseEntity<Imagen> readImagen(
            @RequestParam Long id) {

        Optional<Imagen> imagenData =
    ...
    public ResponseEntity<Imagen> updateImagen(
        ...
        Optional<Imagen> imagenData =
                imagenRepository.findById(imagen.getId());
    ...
    public ResponseEntity<HttpStatus> deleteImagen(
            @RequestParam Long id) {
    ...
    public ResponseEntity<DetallePedido> readDetallePedido(
            @RequestParam Long id) {

        Optional<DetallePedido> detallePedidoData =
                detallePedidoRepository.findById(id);

        if (detallePedidoData.isPresent()) {
            return new ResponseEntity<>(
                    detallePedidoData.get(),
                    HttpStatus.OK);
        } else {
            return new ResponseEntity<>(
                    HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<List<DetallePedido>> getDetallesByPedido(
    ...
    public ResponseEntity<DetallePedido> updateDetallePedido(
        ...
        Optional<DetallePedido> detallePedidoData =
                detallePedidoRepository.findById(detallePedido.getId());
        ...
        if (detallePedidoData.isPresent()) {
            ...
            _detallePedido.setPedidoId(
                    detallePedido.getPedidoId());

            _detallePedido.setProductoId(
                    detallePedido.getProductoId());

            _detallePedido.setPrecio(
                    detallePedido.getPrecio());

            _detallePedido.setCantidad(
                    detallePedido.getCantidad());

            _detallePedido.setSubtotal(
    ...
    public ResponseEntity<HttpStatus> deleteDetallePedido(
            @RequestParam Long id) {
    ...
    public ResponseEntity<DetalleTemp> createDetalleTemp(
            @RequestBody DetalleTemp detalleTemp) {

        try {
            DetalleTemp _detalleTemp =
                    detalleTempRepository.save(detalleTemp);
    ...
    public ResponseEntity<DetalleTemp> readDetalleTemp(
            @RequestParam Long id) {

        Optional<DetalleTemp> detalleTempData =
                detalleTempRepository.findById(id);
    ...
    public ResponseEntity<DetalleTemp> updateDetalleTemp(
            @RequestBody DetalleTemp detalleTemp) {

        Optional<DetalleTemp> detalleTempData =
                detalleTempRepository.findById(detalleTemp.getId());
    ...
    public ResponseEntity<HttpStatus> deleteDetalleTemp(
            @RequestParam Long id) {
    ...
    public ResponseEntity<Pedido> readPedido(
            @RequestParam Long id) {

        Optional<Pedido> pedidoData =
    ...
    public ResponseEntity<Pedido> updatePedido(
        ...
        Optional<Pedido> pedidoData =
                pedidoRepository.findById(pedido.getIdpedido());
        ...
        if (pedidoData.isPresent()) {
            ...
            _pedido.setIdTransaccionPaypal(
                    pedido.getIdTransaccionPaypal());
    ...
    public ResponseEntity<HttpStatus> deletePedido(
            @RequestParam Long id) {
    ...
    public ResponseEntity<List<Pedido>> getPedidosByPersonal(
            @RequestParam Long personal) {

        List<Pedido> pedidos =
                pedidoRepository.findByPersonal(personal);
    ...
    public ResponseEntity<TipoPago> createTipoPago(
    ...
    public ResponseEntity<TipoPago> readTipoPago(
            @RequestParam Long id) {

        Optional<TipoPago> tipoPagoData =
                tipoPagoRepository.findById(id);
    ...
    public ResponseEntity<TipoPago> updateTipoPago(
            @RequestBody TipoPago tipoPago) {

        Optional<TipoPago> tipoPagoData =
                tipoPagoRepository.findById(tipoPago.getIdtipopago());
    ...
    public ResponseEntity<HttpStatus> deleteTipoPago(
            @RequestParam Long id) {
    ...
    public ResponseEntity<Reembolso> createReembolso(
    ...
    public ResponseEntity<Reembolso> readReembolso(
            @RequestParam Long id) {

        Optional<Reembolso> reembolsoData =
                reembolsoRepository.findById(id);
    ...
    public ResponseEntity<Reembolso> updateReembolso(
            @RequestBody Reembolso reembolso) {

        Optional<Reembolso> reembolsoData =
                reembolsoRepository.findById(reembolso.getId());
    ...
    public ResponseEntity<HttpStatus> deleteReembolso(
            @RequestParam Long id) {
    ...
    public ResponseEntity<Suscripciones> createSuscripciones(
            @RequestBody Suscripciones suscripciones) {
    ...
    public ResponseEntity<Suscripciones> readSuscripciones(
            @RequestParam Long id) {

        Optional<Suscripciones> suscripcionesData =
                suscripcionesRepository.findById(id);

        if (suscripcionesData.isPresent()) {
            return new ResponseEntity<>(
                    suscripcionesData.get(),
                    HttpStatus.OK);
        } else {
            return new ResponseEntity<>(
                    HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<Suscripciones> updateSuscripciones(
            @RequestBody Suscripciones suscripciones) {

        Optional<Suscripciones> suscripcionesData =
                suscripcionesRepository.findById(
                        suscripciones.getIdsuscripcion());
        ...
        if (suscripcionesData.isPresent()) {
            ...
            _suscripciones.setDatecreated(
                    suscripciones.getDatecreated());
    ...
    public ResponseEntity<HttpStatus> deleteSuscripciones(
            @RequestParam Long id) {
    ...
    public ResponseEntity<Contacto> readContacto(
            @RequestParam Long id) {

        Optional<Contacto> contactoData =
    ...
    public ResponseEntity<Contacto> updateContacto(
        ...
        Optional<Contacto> contactoData =
                contactoRepository.findById(contacto.getIdcontacto());
    ...
    public ResponseEntity<HttpStatus> deleteContacto(
            @RequestParam Long id) {
    ...
    public ResponseEntity<Post> updatePost(
        ...
        Optional<Post> postData =
                postRepository.findById(post.getIdpost());
    ...
    public ResponseEntity<List<Suscripciones>> listSuscripciones() {
        return new ResponseEntity<>(
                suscripcionesRepository.findAll(),
                HttpStatus.OK);
    }
